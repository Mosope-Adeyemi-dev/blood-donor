    ...
    <div class="whole-container">
        <div class="lhs">
            ...
            <div class="form-sect">
                ...
                <form v-show="activeSect === 'signup'" action="" class="signup-sect">
                    ...
                    <button class="btn-org" @click="activeSect = 'details'">
                        Continue
                    </button>
                </form>
                ...
                <p class="account-prompt">
                    Already have a account ? <NuxtLink to="/donor/login">Login now</NuxtLink>
                </p>
            </div>
        </div>
        <div class="rhs">
