<template>
    <div v-if="showDetailModel" class="donor-whole-modal">
        ...
        <div v-show="requestSent == false" class="modal">
            ...
            <p class="donor-detail modal-type">
                Location - <span class="value">{{  spotlightDonor.address || "Nil" }}</span>
            </p>
            <p class="donor-detail modal-type">
            ...
            <button class="org-btn" @click="requestDonation()">Request Blood</button>
        </div>
        ...
        data() {
            return {
                ...
                donors: [{
                        ...
                        bloodGroup: "0 Negative",
                        genotype: "AA",
                        id: "734659872",
                        phoneNumber: +234736726627,
                        email: "oliv@rhye.com",
                        address: "Ajah Ikeja",
